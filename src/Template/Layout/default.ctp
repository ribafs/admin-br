...
<?php
    if($loguser){
?>
        <h2 align="center" class="titulo"><?= $titulo ?><?php echo $this->element('AdminBr.topmenu') ?></h2>
        <div class="logado" align="center"><?= $this->fetch('title') ?></div>
        <div class="logado pull-right">Logado como: <strong><?=__($loguser) ?></strong></div> 
<?php
    }else{
